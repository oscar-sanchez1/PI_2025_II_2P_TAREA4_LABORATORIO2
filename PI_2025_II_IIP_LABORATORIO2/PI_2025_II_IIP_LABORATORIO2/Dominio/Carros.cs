...
namespace PI_2025_II_IIP_LABORATORIO2.objetos
{
    ...
    {
        public Automovil(string modelo, string placa, string marca, string color, string propietario, string tipo, int año, string accesorios)
            : base(modelo, placa, marca, color, propietario, tipo, año)
        {
            if (!string.IsNullOrEmpty(accesorios))
                Accesorios = new List<string>(accesorios.Split(','));
        }
